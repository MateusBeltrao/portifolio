...
const Data = () => {
  return (
    <div className='home_data'>
        ...
        Sou um desenvolvedor web apaixonado por criar experiências digitais excepcionais. Com habilidades técnicas robustas e uma abordagem criativa, estou comprometido em transformar suas ideias em realidade de maneira eficiente e impactante. Vamos trabalhar juntos para construir algo incrível para o seu projeto?
        </p>
